...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-dark shadow-brand hover:shadow-brand-lg hover-lift",
        ...
        secondary: "bg-secondary text-secondary-foreground hover:bg-secondary-dark hover-lift",
        ghost: "hover:bg-secondary hover:text-secondary-foreground transition-smooth",
        link: "text-primary underline-offset-4 hover:underline",
        gradient: "bg-gradient-primary text-primary-foreground shadow-brand hover:shadow-brand-lg hover-lift font-semibold",
        hero: "bg-gradient-hero text-white shadow-brand-lg hover:shadow-brand-lg hover-lift font-bold border border-white/20",
        success: "bg-success text-success-foreground hover:bg-success/90 shadow-card hover-lift",
        warning: "bg-warning text-warning-foreground hover:bg-warning/90 shadow-card hover-lift",
      },
      size: {
